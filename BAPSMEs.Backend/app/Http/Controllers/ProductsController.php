    ...
    public function store(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'inventory_status' => 'nullable|in:Available,"Out of Stock"',
                'return_policy' => 'nullable|in:Return,"Exchange Terms"',
                'appointment' => 'nullable|in:yes,no',
                'location_type' => 'nullable|in:On-Site,Off-Site,Virtual',
                'expertise_level' => 'nullable|in:Beginner,Intermediate,Advanced',
                'session_format' => 'nullable|in:Individual,Group',
                'course_format' => 'nullable|in:Online,In-person',
                'construction_project_type' => 'nullable|in:New Build,Renovation,Repair',
                'service_scope' => 'nullable|in:"Full Project Management","Consultation-only"',
                'payment_term' => 'nullable|in:Milestone-based,Progressive',
                'coverage_type' => 'nullable|in:Property,Liability,Life',
                'account_type' => 'nullable|in:Personal,Business,investment',
                'service_level' => 'nullable|in:Full,"Partial Management",Basic,Standard,Premium',
